...
type StarRocksListener interface {
	...
	// EnterAlterTableAutoIncrementClause is called when entering the alterTableAutoIncrementClause production.
	EnterAlterTableAutoIncrementClause(c *AlterTableAutoIncrementClauseContext)
	...
	// EnterInIntegerList is called when entering the inIntegerList production.
	EnterInIntegerList(c *InIntegerListContext)

	// EnterInStringList is called when entering the inStringList production.
	EnterInStringList(c *InStringListContext)
	...
	// EnterAlterModifyDefaultBuckets is called when entering the alterModifyDefaultBuckets production.
	EnterAlterModifyDefaultBuckets(c *AlterModifyDefaultBucketsContext)
	...
	// ExitAlterTableAutoIncrementClause is called when exiting the alterTableAutoIncrementClause production.
	ExitAlterTableAutoIncrementClause(c *AlterTableAutoIncrementClauseContext)
	...
	// ExitInIntegerList is called when exiting the inIntegerList production.
	ExitInIntegerList(c *InIntegerListContext)

	// ExitInStringList is called when exiting the inStringList production.
	ExitInStringList(c *InStringListContext)
	...
	// ExitAlterModifyDefaultBuckets is called when exiting the alterModifyDefaultBuckets production.
	ExitAlterModifyDefaultBuckets(c *AlterModifyDefaultBucketsContext)
