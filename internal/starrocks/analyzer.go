...
func (a *sqlAnalyzer) parseOneForLineage(sql, defaultCluster, defaultDatabase string) (*analyzer.LineageResult, error) {
	...
	// 解析并遍历语法树
	antlr.ParseTreeWalkerDefault.Walk(listener, p.SqlStatements())
...
// 参考：https://docs.starrocks.io/docs/3.4/sql-reference/sql-statements/table_bucket_part_index/ALTER_TABLE/#modify-the-column-type-position-comment-and-other-properties
